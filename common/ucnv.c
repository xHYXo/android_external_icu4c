...
#ifdef NEEDS_UCNV_EX_44_WRAPPER
U_CAPI void    U_EXPORT2 ucnv_setToUCallBack_44 (UConverter * converter,
                            UConverterToUCallback newAction,
                            const void* newContext,
                            UConverterToUCallback *oldAction,
                            const void** oldContext,
...
U_CAPI void  U_EXPORT2 ucnv_close_44 (UConverter * converter) {
...
U_STABLE void U_EXPORT2 UCNV_FROM_U_CALLBACK_STOP_44 (
                  const void *context,
                  UConverterFromUnicodeArgs *fromUArgs,
...
U_STABLE void U_EXPORT2 UCNV_TO_U_CALLBACK_STOP_44 (
                  const void *context,
                  UConverterToUnicodeArgs *toUArgs,
